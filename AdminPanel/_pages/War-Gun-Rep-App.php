...
<div class="page-content">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span><i class="fa fa-user"></i> گارانتی های تایید شده</span>
            </li>
        </ul>
...
if( !isset($msg) and !isset($type) ){
	...
	$msg = "لیست گارانتی های تایید شده به شرح زیر می باشد .";
}
?>
...
?>
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list"></i>گارانتی های تایید شده</div>
                                    </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover order-column" id="sample_3">
                                            ...
                                            ?>
												<tr class="odd gradeX">
                                                    ...
                                                    <i class="fa fa-pencil"></i> ویرایش کارت گارانتی</a>
                                                    </td>
