...
if(isset($_GET['Page']))
	...
	switch($Page){
		...
		case "Reseller-Reg";
			$TitleIndex = "ثبت اطلاعات نماینده";
			$URL = "Reseller-Reg.php";
			break;

		case "Gun-Reg";
			$TitleIndex = "ثبت اطلاعات سلاح";
			$URL = "Gun-Reg.php";
			break;			
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-item <?php if( isset($_GET['Page'])) { if ($_GET['Page']== 'Reseller-Reg' or $_GET['Page']== 'Reseller-Reg') { ?>start active open<?php } } ?>">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="fa fa-users"></i>
                                    <span class="title">نمایندگان</span>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item <?php if( isset($_GET['Page']) and $_GET['Page']== 'Reseller-Reg' ) { ?>active<?php } ?> ">
                                        <a href="index.php?Page=Reseller-Reg" class="nav-link">
                                            <span class="title">ثبت اطلاعات نماینده</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="form_repeater.html" class="nav-link ">
                                            <span class="title">ویرایش اطلاعات نمانیده</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
